...
module.exports = {
  ...
  plugins: [
    ...
    `gatsby-plugin-sharp`,
    {
      ...
      options: {
        name: `Future Developer Portfolio`,
        short_name: `Future Developer Portfolio`,
        start_url: `/`,
        background_color: `#1b2d3a`,
        theme_color: `#1b2d3a`,
        display: `minimal-ui`,
        icon: `src/images/terminal.jpg`, // This path is relative to the root of the site.
      },
    },
    {
      resolve: `gatsby-source-filesystem`,
